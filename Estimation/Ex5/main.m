...
%% Task 7
% By varying the sigma in angle measurement, we can notice a change in the
% performance of Ekf and Ukf Update. As the angle increases from 2->4->6
% degrees, the Ekf update logic becomes unstable because of the angle state
% which is highly non linear causes the EKF linear approximation to become
% erratic. Meanwhile the UkF update logic does not get impacted that
% strongly since it depends on a set of sigma points(even this gets
% impacted due to sigma points being chosen from higher unstable gaussian
% curve). This shows, UKF update logic has better use in highly unstable
% models.