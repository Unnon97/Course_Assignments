...
def getCliffGrid2():
    # remove this after implementing the gridworld
    # **********
    # TODO 1.7
    grid = [[' ', ' ', ' ', ' ', ' '],
            [8, 'S', ' ', ' ', 10],
...
if __name__ == '__main__':
    ...
    if opts.agent == 'value':
        ...
        a = QLearningAgent(env.getPossibleActions,
                           opts.discount, opts.learningRate, opts.epsilon)
